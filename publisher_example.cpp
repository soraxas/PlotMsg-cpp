...
int main(int argc, char *argv[])
{
    ...
    std::cout << PlotMsg::TraceTemplate::scatter_with_colour(x, y, o) << std::endl;
    ...
    fig.add_command("update_yaxes", PlotMsg::Dictionary("scaleanchor", "x", "scaleratio", 1));
...

    {
        ...
        std::vector<std::pair<double, double>> ex = {{4.4, 9.4}, {4.4, -3.4}, {4.4, 3.7}};

        std::vector<std::pair<double, double>> ey = {{14.4, 23.4}, {14.4, 8.4}, {14.4, 3.7}};
