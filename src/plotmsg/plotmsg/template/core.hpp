...
template <typename T1, typename T2>
PlotMsg::Trace scatter_with_colour(std::vector<T1> &x, std::vector<T1> &y,
                                   std::vector<T2> &c) {
...
template <typename T>
PlotMsg::Trace vector_field(std::vector<T> &x, std::vector<T> &y,
...
template <typename... T> PlotMsg::Trace quiver(T... args) {
  return vector_field(args...);
}

template <typename T>
PlotMsg::Trace contour(std::vector<T> &x, std::vector<T> &y, std::vector<T> &c,
...
template <typename T>
PlotMsg::Trace heatmap(std::vector<T> &x, std::vector<T> &y,
                       std::vector<T> &c) {
...
template <typename T>
PlotMsg::Trace edges(std::vector<std::pair<T, T>> &x,
...
template <typename T1, typename T2>
PlotMsg::Trace vertices(std::vector<T1> &x, std::vector<T1> &y,
                        std::vector<T2> &c) {
...
template <class Numeric = double,
          typename =
              std::enable_if_t<std::is_arithmetic<Numeric>::value, Numeric>>
